...
uis.controller('uiSelectCtrl',
  ...
  ctrl.allowNewObj = uiSelectConfig.allowNewObj;
  ...
  function _handleBlurAndTab() {
    ...
    else if(ctrl.allowNewObj && ctrl.search) {
      var obj={};
      _.forOwn(ctrl.allowNewObj, function(value,key){
        if(key=='input'){
          obj[value] = ctrl.search;
        }
        else{
          obj[key]=value;
        }
  ...
  ctrl.searchInput.on('keydown', function(e) {
    ...
    $scope.$apply(function() {
      ...
      else if(~[KEY.ESC,KEY.TAB,KEY.ENTER].indexOf(key)){
        if (!ctrl.allowFreeText && !ctrl.allowNewObj) {
          ctrl.close();
        }
        else {
          _handleBlurAndTab();
  ...
  return {
    ...
    compile: function(tElement, tAttrs) {
      ...
      return function(scope, element, attrs, ctrls, transcludeFn) {
        ...
        attrs.$observe('allowNewObj', function(allowNewObj) {
           // No need to use $eval() (thanks to ng-disabled) since we already get a boolean instead of a string
          try{
            $select.allowNewObj = JSON.parse(allowNewObj);
          }
          catch(e){
            $select.allowNewObj = undefined;
          }
