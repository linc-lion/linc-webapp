...
.directive('uploadImages', function($uibModal) {
  return {
    ...
    template: function(element, attrs) {
      switch (attrs.type) {
        case 'new':
          return '<a class="btn btn-primary" data-animation="am-fade-and-slide-top" ng-click="showNew()" ng-disabled="disabledBtn"><i class="icon icon-camera"></i> Create & Add Images</a>';
        default:
